export const projects = [
  ...
  },
  {
    ...
    solution: "Implemented automated Laravel Console Scheduled Cron Jobs (`MedicationEmailCronJob`), integrated Twilio API for multi-channel SMS notifications, built a responsive AI chatbot interface, and containerized the entire stack with Docker Compose and Nginx.",
    technologies: ["PHP", "Laravel", "MySQL", "Docker", "Twilio API", "AI Chatbot", "Scheduled Cron Jobs", "Tailwind CSS"],
    highlights: [
      "Real-time Drug Interaction & Contraindication Checker",
      "AI-Powered Medical Chatbot Assistant for patient inquiries",
      "Automated SMS & Email Medication Reminder engine via Scheduled Cron & Twilio",
      "Digital Prescription Tracking, Health Metrics Logging & Appointment Scheduling",
      "Containerized deployment with Docker Compose & Nginx setup"
    ],
    availability: "Public / Open Source Project",
    confidential: false,
